        ...
        <>
            <div className='container mx-auto flex justify-between p-5 items-center font-raleway'>
                ...
                <div className='hidden lg:flex gap-x-5 text-[#A9A9A9] font-thin text-lg items-center relative'>
                    ...
                    {isPopupVisible && (
                        <div className="absolute top-0 right-0 mt-16 mr-4 z-50" ref={popupRef}>
                            <CardPopup />
                        </div>
                    )}
                </div>
            ...
            {isPopupVisible && (
                <div className="lg:hidden p-4 bg-white ">
                    <ul className="flex flex-col gap-4">
                        <li>
                            <Link to='/' className="text-footerText" onClick={handleToggleClick}>HOME</Link>
                        </li>
                        <li>
                            <Link to='/about' className="text-footerText" onClick={handleToggleClick}>ABOUT</Link>
                        </li>
                        <li>
                            <Link to='/contact' className="text-footerText" onClick={handleToggleClick}>CONTACT</Link>
                        </li>
                    </ul>
                </div>
            )}
